sudo ifconfig eth0:1 172.29.1.1/1
sudo ifconfig eth0:2 172.29.1.2/1
sudo ifconfig eth0:3 172.29.1.3/1
sudo ifconfig eth0:4 172.29.1.4/1
sudo ifconfig eth0:5 172.29.1.5/1
sudo ifconfig eth0:6 172.29.1.6/1

sudo ifconfig eth0:7 172.29.2.1/1
sudo ifconfig eth0:8 172.29.2.2/1
